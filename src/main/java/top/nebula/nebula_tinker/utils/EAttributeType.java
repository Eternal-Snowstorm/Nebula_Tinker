...
public enum EAttributeType {
	...
	MOVEMENT_SPEED_SMALL(
			...
			0.08,
			setTranKey("movement_speed_small"),
	...
	MOVEMENT_SPEED_MEDIUM(
			Attributes.MOVEMENT_SPEED,
			0.15,
			setTranKey("movement_speed_medium"),
			EnumSet.of(EquipmentSlot.FEET),
			AttributeCategory.UTILITY,
			8,
			3
	),
	MOVEMENT_SPEED_LARGE(
			Attributes.MOVEMENT_SPEED,
			0.25,
			setTranKey("movement_speed_large"),
			EnumSet.of(EquipmentSlot.FEET),
			AttributeCategory.UTILITY,
			6,
			4
	...
	// 武器负面属性
	HEALTH_REDUCTION_SMALL(
			Attributes.MAX_HEALTH,
			-2.0,
			setTranKey("health_reduction_small"),
			EnumSet.of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND),
			AttributeCategory.NEGATIVE_WEAPON,
			5,
			1
	),
	HEALTH_REDUCTION_MEDIUM(
			Attributes.MAX_HEALTH,
			-4.0,
			setTranKey("health_reduction_medium"),
			EnumSet.of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND),
			AttributeCategory.NEGATIVE_WEAPON,
			3,
			2
	...
	ARMOR_REDUCTION_SMALL(
			Attributes.ARMOR,
			-1.0,
			setTranKey("armor_reduction_small"),
			EnumSet.of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND),
			AttributeCategory.NEGATIVE_WEAPON,
			6,
			1
	),
	ARMOR_REDUCTION_MEDIUM(
			Attributes.ARMOR,
			-2.0,
			setTranKey("armor_reduction_medium"),
			EnumSet.of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND),
			AttributeCategory.NEGATIVE_WEAPON,
			4,
			2
	...
	MOVEMENT_SLOW_SMALL(
			Attributes.MOVEMENT_SPEED,
			-0.05,
			setTranKey("movement_slow_small"),
			EnumSet.of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND),
			AttributeCategory.NEGATIVE_WEAPON,
			7,
			1
	),
	MOVEMENT_SLOW_MEDIUM(
			Attributes.MOVEMENT_SPEED,
			-0.10,
			setTranKey("movement_slow_medium"),
			EnumSet.of(EquipmentSlot.MAINHAND, EquipmentSlot.OFFHAND),
			AttributeCategory.NEGATIVE_WEAPON,
			5,
			2
	...
	// 盔甲负面属性
	ATTACK_DAMAGE_REDUCTION_SMALL(
			Attributes.ATTACK_DAMAGE,
			-0.3,
			setTranKey("attack_damage_reduction_small"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			8,
			1
	),
	ATTACK_DAMAGE_REDUCTION_MEDIUM(
			Attributes.ATTACK_DAMAGE,
			-0.6,
			setTranKey("attack_damage_reduction_medium"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			6,
			2
	...
	ATTACK_SPEED_REDUCTION_SMALL(
			Attributes.ATTACK_SPEED,
			-0.05,
			setTranKey("attack_speed_reduction_small"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			9,
			1
	),
	ATTACK_SPEED_REDUCTION_MEDIUM(
			Attributes.ATTACK_SPEED,
			-0.10,
			setTranKey("attack_speed_reduction_medium"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			7,
			2
	...
	CRITICAL_REDUCTION_SMALL(
			null,
			-0.03,
			setTranKey("critical_reduction_small"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			4,
			2
	),
	CRITICAL_REDUCTION_MEDIUM(
			null,
			-0.06,
			setTranKey("critical_reduction_medium"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			2,
			3
	...
	// 工具负面属性
	MINING_SPEED_REDUCTION_SMALL(
			null,
			-0.2,
			setTranKey("mining_speed_reduction_small"),
			EnumSet.of(EquipmentSlot.MAINHAND),
			AttributeCategory.NEGATIVE_TOOL,
			10,
			1
	),
	MINING_SPEED_REDUCTION_MEDIUM(
			null,
			-0.4,
			setTranKey("mining_speed_reduction_medium"),
			EnumSet.of(EquipmentSlot.MAINHAND),
			AttributeCategory.NEGATIVE_TOOL,
			8,
			2
	...
	DURABILITY_REDUCTION_SMALL(
			null,
			-50.0,
			setTranKey("durability_reduction_small"),
			EnumSet.of(EquipmentSlot.MAINHAND),
			AttributeCategory.NEGATIVE_TOOL,
			8,
			1
	),
	DURABILITY_REDUCTION_MEDIUM(
			null,
			-100.0,
			setTranKey("durability_reduction_medium"),
			EnumSet.of(EquipmentSlot.MAINHAND),
			AttributeCategory.NEGATIVE_TOOL,
			6,
			2
	...
	HARVEST_LEVEL_REDUCTION_SMALL(
			null,
			-0.5,
			setTranKey("harvest_level_reduction_small"),
			EnumSet.of(EquipmentSlot.MAINHAND),
			AttributeCategory.NEGATIVE_TOOL,
			3,
			2
	),
	HARVEST_LEVEL_REDUCTION_MEDIUM(
			null,
			-1.0,
			setTranKey("harvest_level_reduction_medium"),
			EnumSet.of(EquipmentSlot.MAINHAND),
			AttributeCategory.NEGATIVE_TOOL,
			1,
			3
	...
	// 暴击伤害负面属性
	CRITICAL_DAMAGE_REDUCTION_SMALL(
			null,
			-0.1,
			setTranKey("critical_damage_reduction_small"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			5,
			2
	),
	CRITICAL_DAMAGE_REDUCTION_MEDIUM(
			null,
			-0.2,
			setTranKey("critical_damage_reduction_medium"),
			EnumSet.of(EquipmentSlot.HEAD, EquipmentSlot.CHEST, EquipmentSlot.LEGS, EquipmentSlot.FEET),
			AttributeCategory.NEGATIVE_ARMOR,
			3,
			3
